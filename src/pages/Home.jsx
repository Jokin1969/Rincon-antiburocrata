...
const MODULES = [
  ...
  },
  {
    ...
    description: 'Genera cartas de referencia profesionales, de apoyo a proyectos o para visas. Asistencia con IA (Claude, ChatGPT, Gemini), descarga en DOCX/PDF y envío por email.',
    icon: '📜',
