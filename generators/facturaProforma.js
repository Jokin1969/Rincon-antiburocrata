...
const TR = {
  en: {
    ...
    fax:         'Fax',
    email:       'Email',
    research:    'FOR RESEARCH PURPOSES ONLY — NOT FOR HUMAN USE — NO COMMERCIAL VALUE',
    legal: [
      'We hereby certify that the goods described in this invoice are of Spanish origin and that the prices stated are correct and conform to those charged in the normal course of trade.',
      'These materials are shipped for scientific research purposes only and are not intended for commercial use, resale, or human diagnostic or therapeutic use.',
    ],
  ...
  es: {
    ...
    fax:         'Fax',
    email:       'Email',
    research:    'SOLO PARA FINES DE INVESTIGACIÓN — NO PARA USO HUMANO — SIN VALOR COMERCIAL',
    legal: [
      'Por la presente certificamos que las mercancías descritas en esta factura son de origen español y que los precios indicados son correctos y conformes a los aplicados en el curso normal del comercio.',
      'Estos materiales se envían únicamente con fines de investigación científica y no están destinados a uso comercial, reventa ni uso diagnóstico o terapéutico en humanos.',
    ],
